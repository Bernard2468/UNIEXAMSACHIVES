...
// Dark mode removed — the system is light-mode only. (The #light--to-dark-button
// toggle no longer exists; this guard block is kept because it also wraps the
// gallery slider initialisation below.)
