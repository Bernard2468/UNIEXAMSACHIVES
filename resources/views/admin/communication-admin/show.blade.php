                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <div class="dashboard__content__wraper">
                        ...
                        <div class="memo-view">
                            ...
                            <div class="mv-topbar">
                                <nav class="mv-crumb">
                                    <a href="{{ route('admin.communication-admin.index') }}">Memos</a>
                                    <span class="sep">/</span>
                                    <span class="cur">Details</span>
                                </nav>
                                <div class="mv-actions">
                                    <a href="{{ route('admin.communication-admin.index') }}" class="mv-btn ghost">
                                        <i class="icofont-simple-left"></i><span>Back</span>
                                    </a>
                                    @if($campaign->status === 'draft')
                                        <a href="{{ route('admin.communication-admin.edit', $campaign) }}" class="mv-btn ghost">
                                            ...
                                            <div class="mv-files">
                                                @foreach($campaign->attachments as $index => $attachment)
                                                    <div class="mv-file">
                                                        ...
                                                        <a class="dl" href="{{ route('admin.communication-admin.download-attachment', [$campaign, $index]) }}" title="Download">
