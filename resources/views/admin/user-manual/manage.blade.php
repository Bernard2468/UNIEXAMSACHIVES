                        ...
                        <div class="table-header-controls">
                            <div class="table-title-section">
                                <div class="dashboard__section__title">
                                    <h4>Manage User Manual</h4>
                                </div>
                            </div>
                            <div class="table-controls">
                                <div class="search-filter-container">
                                    <div class="search-wrapper">
                                        <input type="text" class="search-input" id="documentSearchInput" placeholder="Search manuals...">
                                    ...
                                    <div class="table-container">
                                        <table class="documents-table" id="documentsTable">
                                            ...
                                            <tbody>
                                                        ...
                                                        <td onclick="event.stopPropagation()">
                                                            <div class="action-buttons">
                                                                ...
                                                                <button type="button" class="btn-action btn-preview"
                                                                    onclick="openManualPreview(this)"
                                                                    data-preview-url="{{ route('dashboard.user-manual.manage.preview', $document->id) }}"
                                                                    data-download-url="{{ route('dashboard.user-manual.manage.download', $document->id) }}"
                                                                    data-name="{{ $document->title }}.pdf">
                                                                    <i class="icofont-eye-alt"></i>
                                                                </button>
                                                                @endif
                                                                <a href="{{ route('dashboard.user-manual.manage.download', $document->id) }}" class="btn-action btn-download">
                                                                ...
                                                                <form action="{{ route('dashboard.user-manual.manage.destroy', $document->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this manual?')">
                                                                    @csrf
                                                                    @method('DELETE')
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="4" class="text-center" style="padding: 2rem; color: #6b7280;">No manuals found.</td>
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
...
<div id="documentDetailModal" class="document-modal">
    <div class="document-modal-content">
        <div class="document-modal-header">
            <h3 class="document-modal-title">Manual Details</h3>
            <button class="document-modal-close" onclick="closeDocumentModal()">&times;</button>
        </div>
        <div class="document-modal-body">
            <span class="document-modal-label">Manual Title</span>
...
<div id="addDocumentModal" class="document-modal">
    <div class="document-modal-content form-modal-content">
        <div class="document-modal-header">
            <h3 class="document-modal-title">Add New Manual</h3>
            <button class="document-modal-close" onclick="closeAddModal()">&times;</button>
        </div>
        <form action="{{ route('dashboard.user-manual.manage.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="document-modal-body">
                <div class="form-group">
                    <label class="form-label required">Manual Title</label>
                    <input type="text" name="title" class="form-control" required placeholder="Enter manual title">
                </div>
                <div class="form-group">
                    <label class="form-label required">Description</label>
                    <textarea name="description" class="form-control" required placeholder="Enter manual description"></textarea>
                </div>
                <div class="form-group">
                    <label class="form-label required">Manual File</label>
            ...
            <div class="form-modal-footer">
                ...
                <button type="submit" class="btn-submit">Upload Manual</button>
            </div>
        </form>
    </div>
</div>
...
<div id="editDocumentModal" class="document-modal">
    <div class="document-modal-content form-modal-content">
        <div class="document-modal-header">
            <h3 class="document-modal-title">Edit Manual</h3>
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="document-modal-body">
                <div class="form-group">
                    <label class="form-label required">Manual Title</label>
                    <input type="text" name="title" id="editTitle" class="form-control" required placeholder="Enter manual title">
                </div>
                <div class="form-group">
                    <label class="form-label required">Description</label>
                    <textarea name="description" id="editDescription" class="form-control" required placeholder="Enter manual description"></textarea>
                </div>
                <div class="form-group">
                    <label class="form-label">Replace Manual File (optional)</label>
            ...
            <div class="form-modal-footer">
                ...
                <button type="submit" class="btn-submit">Update Manual</button>
            </div>
        </form>
    </div>
</div>
...
// Open the shared attachment-viewer modal (same modal used on the Forms pages)
// instead of navigating away to a new tab.
function openManualPreview(btn) {
    const previewUrl = btn.dataset.previewUrl;
    const downloadUrl = btn.dataset.downloadUrl;
    const name = btn.dataset.name;
    if (window.attachmentViewer) {
        window.attachmentViewer.openOne({
            url: previewUrl,
...
function openEditModal(id, title, description) {
    ...
    document.getElementById('editForm').action = `/dashboard/user-manual/manage/${id}`;
    document.getElementById('editDocumentModal').classList.add('show');
    document.body.style.overflow = 'hidden';
}

// Close edit manual modal
