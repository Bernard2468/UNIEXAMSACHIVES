                                                        ...
                                                        <td onclick="event.stopPropagation()">
                                                            <div class="action-buttons">
                                                                ...
                                                                <button type="button" class="btn-action btn-preview"
                                                                    ...
                                                                    data-preview-url="{{ route('dashboard.user-manual.preview', $document->id) }}"
                                                                    data-download-url="{{ route('dashboard.user-manual.download', $document->id) }}"
                                                                    data-name="{{ $document->title }}.pdf">
                                                                    <i class="icofont-eye-alt"></i>
                                                                    Preview
                                                                </button>
                                                                @endif
                                                                <a href="{{ route('dashboard.user-manual.download', $document->id) }}" class="btn-action btn-download">
...
function openManualPreview(btn) {
    ...
    if (window.attachmentViewer) {
        ...
        // Fallback if the shared modal isn't on the page for some reason.
