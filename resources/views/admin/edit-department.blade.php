                ...
                <div class="col-xl-9 col-lg-9 col-md-12">
                    <div class="ed-wrap">
                        ...
                        <div class="ed-page-header">
                            <a href="{{ route('departments.index') }}" class="ed-back">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 12H5M12 5l-7 7 7 7"/></svg>
                                Back to departments
                            </a>
                            <h1 class="ed-page-title">Edit department<span class="ed-title-bar"></span></h1>
                            <p class="ed-page-sub">Update the name of this department, faculty, or unit.</p>
                        </div>

                        {{-- Edit card --}}
                        <div class="ed-card">
                            <div class="ed-card__hd">
                                <h2 class="ed-card__title">Department details<span class="ed-card__bar"></span></h2>
                                <p class="ed-card__sub">Editing: <strong>{{ $department->name }}</strong></p>
                            </div>
                            <div class="ed-card__body">
                                <form action="{{ route('departments.update', $department->id) }}" method="POST">
                                    ...
                                    @if($errors->any())
                                    <div class="ed-alert ed-alert--err">
                                    ...
                                    <div class="ed-foot">
                                        <a href="{{ route('departments.index') }}" class="ed-btn-cancel">
...
.ed-wrap, .ed-wrap * { font-family: 'Outfit', sans-serif !important; box-sizing: border-box; }
.ed-wrap { max-width: 680px; padding: 4px 0 60px; }

/* ── Page header ── */
.ed-page-header { margin-bottom: 28px; padding-bottom: 24px; border-bottom: 1.5px solid #ebebeb; }
...
.ed-back:hover { color: #374151; text-decoration: none; }
...
.ed-title-bar { display: block; width: 2.4rem; height: 3.5px; background: #0c0c0c; border-radius: 3px; margin-top: 9px; }
.ed-page-sub { margin: 14px 0 0; font-size: 0.9rem; color: #8a8fa0; }

/* ── Card ── */
.ed-card { background: #fff; border: 1.5px solid #ebebeb; border-radius: 16px; overflow: hidden; }
.ed-card__hd { padding: 20px 26px 16px; border-bottom: 1.5px solid #f5f5f5; }
.ed-card__title {
...
.ed-card__bar { display: block; width: 1.7rem; height: 2.5px; background: #0c0c0c; border-radius: 2px; margin-top: 6px; }
.ed-card__sub { margin: 8px 0 0; font-size: 0.82rem; color: #9ca3af; }
.ed-card__sub strong { color: #374151; font-weight: 600; }
.ed-card__body { padding: 24px 26px 26px; }
...
.ed-alert--err { background: #fef2f2; border-color: #fecaca; color: #b91c1c; }

/* ── Field ── */
.ed-field { margin-bottom: 24px; }
.ed-label { display: block; font-size: 0.82rem; font-weight: 600; color: #374151; margin-bottom: 8px; letter-spacing: .01em; }
.ed-input {
...
.ed-input:hover { border-color: #d1d5db; }
.ed-input:focus { border-color: #0c0c0c; box-shadow: 0 0 0 3px rgba(12,12,12,.08); }
.ed-input::placeholder { color: #d4d7de; }
...
.ed-btn-cancel:hover { border-color: #d1d5db; color: #374151; background: #f9fafb; text-decoration: none; }
.ed-btn-save {
