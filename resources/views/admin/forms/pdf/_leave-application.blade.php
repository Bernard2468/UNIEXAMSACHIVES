{{--
    Shared paper-form-faithful PDF used by every form in the leave family
    (Annual, Casual, … — see BaseLeaveApplicationForm). The header title is
    pulled from $definition->title() so the same template serves all leave
    types. Stage data keys (must match BaseLeaveApplicationForm):
