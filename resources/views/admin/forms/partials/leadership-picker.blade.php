...
.lead-picker__search { position: relative; padding: 10px 16px; background: #fff; }
.lead-picker__search svg { position: absolute; top: 50%; left: 30px; transform: translateY(-50%); color: #6b7280; pointer-events: none; }
...
.lead-picker .lead-picker__search-input { width: 100%; padding: 10px 14px 10px 48px; background: #fafafa; border: 1.5px solid #ebebeb; border-radius: 9px; font-size: 0.84rem; color: #111827; outline: none; transition: all .15s; font-family: 'Outfit', sans-serif !important; }
.lead-picker .lead-picker__search-input:focus { background: #fff; border-color: #0c0c0c; box-shadow: 0 0 0 3px rgba(12,12,12,.06); }
.lead-picker .lead-picker__search-input::placeholder { color: #c7cbd6; }
