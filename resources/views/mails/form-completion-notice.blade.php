...
<head>
    ...
    <title>Now complete — {{ $submission->reference }}</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .links span.arrow { display: inline-block; vertical-align: -1px; margin-right: 4px; }
    ...
    <div class="wrap">
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="links">
                    <a href="{{ $showUrl }}"><span class="arrow">&darr;</span> View signed form</a>
                    <a href="{{ route('admin.forms.pdf', $submission->id) }}"><span class="arrow">&darr;</span> Download PDF</a>
                </div>
